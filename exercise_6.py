...
try:
    while count <= goods_quantity_in_data_base:     # в техзадании условие не указано
        ...
        dict_goods[key_1] = name
        dict_goods[key_2] = price
        dict_goods[key_3] = quantity
        dict_goods[key_4] = measure
...
measure_set = set()
count = 0
while count <= len(list_goods)-1:
    for elem in list_goods:
        name_list.append(list_goods[count][1][key_1])
        price_list.append(list_goods[count][1][key_2])
        quantity_list.append(list_goods[count][1][key_3])
        measure_set.add(list_goods[count][1][key_4])
        count += 1
analysis_dict[key_1] = name_list
analysis_dict[key_2] = price_list
analysis_dict[key_3] = quantity_list
analysis_dict[key_4] = list(measure_set)
